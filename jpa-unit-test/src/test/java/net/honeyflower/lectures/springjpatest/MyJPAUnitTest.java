package net.honeyflower.lectures.springjpatest;
...
import net.honeyflower.lectures.springjpatest.repo.CustomerRepository;
...
public class MyJPAUnitTest {
	...
	public void should_find_customer_by_id() {
		...
		Customer foundCustomer = repository.findById(customer2.getId()).orElseThrow();
